...
pub fn install() -> Result<()> {
    ...
    println!("{}", "🔧 Installing Docker-First shims...".bright_blue());
    println!();
    ...
    for cmd in &manifest.docker.shim_commands {
        ...
        println!("   {} bin/{}", "✓".green(), cmd);
    }

    println!();
    println!("{}", "✅ Shims installed successfully!".green());
    println!();
...
pub fn list() -> Result<()> {
    ...
    println!("{}", "📋 Installed shims:".bright_blue());
    println!();
...
pub fn uninstall() -> Result<()> {
    ...
    println!("{}", "🗑️  Removing airis shims...".bright_blue());
    println!();
    ...
    for entry in fs::read_dir(bin_dir)? {
        ...
        if path.is_file() && is_airis_shim(&path) {
            fs::remove_file(&path)?;
            println!("   {} bin/{}", "✓".green(), name_str);
            removed += 1;
        } else if path.is_file() {
            println!("   {} bin/{} (not an airis shim, skipped)", "⏭️".yellow(), name_str);
            skipped += 1;
        }
    }
